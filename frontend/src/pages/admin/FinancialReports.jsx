...
const FinancialReports = () => {
    ...
    if (error && error.includes('403')) {
        return (
            <DashboardLayout title="ACCÈS RESTREINT" noPadding>
                <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-6">
                    <div className="max-w-md w-full bg-white p-10 rounded-[3rem] border border-slate-100 shadow-2xl flex flex-col items-center text-center gap-6">
                        ...
                        <div className="space-y-2">
                            <h2 className="text-2xl font-black text-slate-900 uppercase tracking-tighter">Accès Refusé</h2>
                            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest leading-relaxed">
                                Vos privilèges actuels ne permettent pas d'accéder aux données financières sensibles.
                            </p>
                        </div>
                        <button 
                            onClick={() => window.location.href = '/dashboard'}
                            className="w-full h-12 bg-slate-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-slate-800 transition-all"
                        >
                            Retour au Dashboard
                        </button>
                    </div>
    ...
    const handleExportCSV = () => {
        ...
        setShowExportMenu(false);
        toast.success("FICHIER CSV DÉPLOYÉ.");
    };
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.3em]">
                                    FLUX SATELLITE ACTIF • SYNC_MASTER
                                </p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        {['7J', '30J', 'MAX'].map(p => (
                                            <button
                                                ...
                                                className={cn(
                                                    "text-[10px] font-black uppercase tracking-widest px-6 h-10 rounded-xl transition-all",
                        ...
                        <div className="lg:col-span-4 flex flex-col gap-8">
                            ...
                            <div className="bg-slate-900 p-8 rounded-[2.5rem] border border-slate-800 flex items-center gap-6 overflow-hidden relative group shadow-2xl shadow-slate-900/40">
                                ...
                                <div className="space-y-1 relative z-10">
                                    <p className="text-[11px] font-black text-white uppercase tracking-[0.2em]">Sécurité Chiffrée</p>
