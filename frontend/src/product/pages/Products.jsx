...
const Products = () => {
    ...
    const handleDelete = async (product, confirmationText) => {
        await deleteMutation.mutateAsync({ id: product.id, confirmationText });
    ...
    return (
        <DashboardLayout title={t('invTitle')} noPadding>
            ...
            <ConfirmDeleteModal
                ...
                itemName={deleteConfirm?.nom_produit}
                itemLabel="ce produit"
                onConfirm={(confirmationText) => handleDelete(deleteConfirm, confirmationText)}
            />
