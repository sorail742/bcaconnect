...
import { useVendors } from '../../shop/hooks/useVendorData';
        ...
        },
        {
            ...
            render: (v) => (
                <div className="flex items-center gap-1.5">
                    <Star className={v.rating ? "size-4 text-amber-500 fill-amber-500" : "size-4 text-slate-300"} />
                    <span className="text-sm font-semibold">
                        {v.rating ? `${v.rating} (${v.nb_avis})` : 'Aucun avis'}
                    </span>
                </div>
            )
        },
