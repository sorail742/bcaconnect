...
import shippingService from '../../order/services/shippingService';
...
const CartPage = () => {
    ...
    const handleRemove = (item) => {
        removeFromCart(item.lineId || item.id);
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-2 space-y-4">
                            {cartItems.map(item => {
                                ...
                                return (
                                    <div key={item.lineId || item.id} className="flex gap-4 p-4 bg-card rounded-2xl border border-border hover:border-primary/30 transition-all group shadow-sm">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-start justify-between gap-3">
                                                <div className="min-w-0">
                                                    ...
                                                    {item.variant_nom && (
                                                        <p className="text-xs text-muted-foreground mt-0.5">{item.variant_nom}</p>
                                                    )}
                                                </div>
                                            ...
                                            <div className="flex items-center justify-between mt-3">
                                                <div className="flex items-center gap-1 bg-muted border border-border rounded-lg p-0.5">
                                                    <button onClick={() => updateQuantity(item.lineId || item.id, item.quantity - 1)}
