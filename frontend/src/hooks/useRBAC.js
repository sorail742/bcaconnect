...
const PERMISSIONS = {
    admin: [
        ...
        'view_all_transactions', 'solve_disputes', 'view_admin_dashboard', 'manage_ads', 'manage_education'
    ],
    fournisseur: [
        'manage_own_products', 'view_own_orders', 'update_order_item_status',
        'view_vendor_insights', 'manage_own_store', 'manage_ads'
    ],
    transporteur: [
    ...
    banque: [
        'view_financial_reports', 'view_all_transactions', 'manage_credits', 'view_admin_dashboard'
    ],
    technicien: [
        'view_available_missions', 'accept_mission', 'complete_mission',
        'view_own_equipments', 'view_own_profile'
    ]
};
