        ...
        <section className="bg-white py-10 sm:py-16 border-t border-slate-100">
            <div className="max-w-[1400px] mx-auto px-3 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
                    <div className="space-y-2">
                        ...
                        <p className="text-slate-500 text-sm pl-4 ml-1 border-l-2 border-slate-100">
                            Rejoignez des milliers de professionnels qui transforment leur commerce en Guinée
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        <div className="flex flex-col items-end">
                            ...
                            <span className="text-xs text-slate-500 font-medium">Note globale <AnimatedCounter value="4.9" />/5</span>
                        </div>
                ...
                <div className="mt-8 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 py-5 border-t border-slate-100">
                    {[
                        { emoji: '🏆', text: '10,000+ membres actifs' },
                        { emoji: '✅', text: 'Fournisseurs 100% vérifiés' },
                        { emoji: '🔒', text: 'Paiements Escrow sécurisés' },
                        { emoji: '🚚', text: 'Livraison suivie GPS' },
                        { emoji: '⭐', text: '99.8% satisfaction' },
                    ].map((item, i) => (
