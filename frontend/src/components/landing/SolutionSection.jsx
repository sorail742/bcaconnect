                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-12 xl:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {solutions.map((solution, index) => (
                            ...
                            >
                                <TiltWrapper className="group relative overflow-hidden rounded-2xl bg-card border border-border transition-all duration-300 hover:border-primary/40 hover:shadow-[0_40px_80px_-20px_rgba(255,102,0,0.1)] h-full flex flex-col">
