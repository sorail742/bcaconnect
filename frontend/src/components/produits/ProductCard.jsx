                ...
                <div className="flex items-center gap-3 py-1">
                    ...
                    <p className="text-executive-label text-muted-foreground italic">
                        Par <Link
                            ...
                            className="text-foreground hover:text-primary transition-colors cursor-pointer font-bold underline-offset-4 hover:underline"
                        >
                            {product.Store?.nom_boutique || 'BCA Partner'}
                        </Link>
                    </p>
                </div>
