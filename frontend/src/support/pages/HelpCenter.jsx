...
import { useTickets } from '../hooks/useSupportData';
                ...
                >
                    ...
                    <div className="relative max-w-2xl mx-auto group mt-8">
                        ...
                        <input
                            ...
                            className="w-full h-12 pl-16 pr-6 bg-card border-2 border-border focus:border-primary rounded-2xl text-sm font-bold outline-none shadow-2xl transition-all"
                            value={searchQuery}
            ...
            <div className="max-w-7xl mx-auto px-6 py-16 relative z-20">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {FAQ_CATEGORIES.map((cat, i) => (
                                    <motion.div
                                        ...
                                        whileHover={{ y: -5 }}
                                        className="p-6 bg-card border border-border rounded-2xl hover:border-primary/40 hover:shadow-2xl transition-all cursor-pointer group"
                                    >
                                        <div className="size-11 rounded-2xl bg-primary/10 flex items-center justify-center mb-6 text-primary border border-primary/20">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                            ...
                            {showTicketForm ? (
                                ...
                                >
                                    ...
                                    <div className="relative z-10 space-y-6">
                                        <div className="size-12 rounded-xl bg-[#1CA0DB] flex items-center justify-center mb-6">
                                        ...
                                        <div className="space-y-3 pt-2">
                                            <div className="flex items-center gap-3 text-sm text-slate-200">
                                                <CheckCircle2 className="size-4 text-[#1CA0DB]" /> 100% basé en Guinée
                                            </div>
                                            <div className="flex items-center gap-3 text-sm text-slate-200">
                                                <CheckCircle2 className="size-4 text-[#1CA0DB]" /> Lundi - Samedi, 8h-18h
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="p-6 bg-muted/50 border border-border rounded-2xl flex gap-4 mt-6">
