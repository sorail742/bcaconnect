...
export function HowItWorks() {
    ...
    const STEPS = [
        ...
        },
        {
            ...
            color: "text-[#1CA0DB]", bg: "bg-blue-50", link: "/marketplace"
        },
        {
            ...
            <div className="container px-3 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8 sm:mb-10">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 h-10 px-5 bg-[#1CA0DB] text-white font-bold text-sm rounded-xl hover:bg-blue-600 transition-colors shrink-0 self-start sm:self-auto"
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 relative">
                    ...
                    <div className="absolute top-10 left-[12.5%] right-[12.5%] h-px bg-gradient-to-r from-blue-200 via-blue-200 to-amber-200 hidden lg:block pointer-events-none z-0" />
                    ...
                    {STEPS.map((step, i) => (
                        <motion.button
                            ...
                            className="group text-left relative z-10 bg-white border border-slate-100 rounded-2xl p-5 sm:p-6 hover:shadow-lg hover:border-[#1CA0DB]/20 transition-all duration-300"
                        >
                            {/* Step number + icon */}
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3 p-5 sm:p-6 bg-slate-50 rounded-2xl border border-slate-100">
                    ...
                    <div className="flex gap-2">
                        <button
                            ...
                            className="h-9 px-5 bg-[#1CA0DB] text-white font-bold text-xs rounded-xl hover:bg-blue-600 transition-colors"
                        >
                            {t('register')}
                        </button>
                        <button
                            onClick={() => navigate('/marketplace')}
                            className="h-9 px-5 bg-white border border-slate-200 text-slate-700 font-bold text-xs rounded-xl hover:border-[#1CA0DB] hover:text-[#1CA0DB] transition-colors"
                        >
                            {t('explore')}
                        </button>
                    </div>
