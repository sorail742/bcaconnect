                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {roles.map((role, idx) => (
                        <motion.div
                            ...
                            className="group relative bg-white border border-slate-100 rounded-3xl p-6 hover:shadow-xl hover:border-[#1CA0DB]/20 transition-all duration-300 overflow-hidden"
                        >
                            {/* Icon & Title */}
                            ...
                            <button
                                ...
                                className={cn(
                                    ...
                                    isAuthenticated && user?.role === (role.id === 'fournisseur' ? ROLES.FOURNISSEUR : role.id === 'transporteur' ? ROLES.TRANSPORTEUR : role.id === 'banque' ? ROLES.BANQUE : ROLES.CLIENT)
                                        ...
                                        : "bg-slate-50 text-slate-600 hover:bg-[#1CA0DB] hover:text-white"
                                )}
                            >
                                {isAuthenticated && user?.role === (role.id === 'fournisseur' ? ROLES.FOURNISSEUR : role.id === 'transporteur' ? ROLES.TRANSPORTEUR : role.id === 'banque' ? ROLES.BANQUE : ROLES.CLIENT)
