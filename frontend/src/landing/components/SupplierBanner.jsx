        ...
        <section className="bg-white border-t border-slate-100 py-8 sm:py-10">
            <div className="container px-3 sm:px-6 lg:px-8">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#1CA0DB] via-[#0E86B4] to-[#4FC3F7] p-6 sm:p-8 lg:p-10"
                >
                        ...
                        <div className="flex-1 min-w-0 text-center lg:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3">
                                <button
                                    ...
                                    className="flex items-center gap-2 h-12 sm:h-14 px-6 sm:px-8 bg-white text-[#1CA0DB] font-black text-sm rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl hover:scale-105 transition-all group"
                                >
                ...
                <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
                    {[
                        ...
                        <motion.div
                            ...
                            className="flex items-start gap-3 p-4 bg-white rounded-xl border border-slate-100 hover:border-[#1CA0DB]/20 hover:shadow-sm transition-all"
                        >
                            <div className="size-9 sm:size-10 rounded-xl bg-blue-50 flex items-center justify-center shrink-0">
