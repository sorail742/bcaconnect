...
import {
    ...
    Store, Users, Package, HelpCircle,
                ...
                <div className="flex items-center gap-8">
                    <Link to="/" className="flex items-center gap-6 group">
                        <motion.div
                            ...
                            className="rounded-[1.4rem] shadow-sm overflow-hidden"
                        >
                            <BcaLogo type="icon" size="h-16" />
                        </motion.div>
                        ...
                        <Link to="/cart" className="size-18 flex items-center justify-center rounded-[1.8rem] bg-card text-muted-foreground hover:text-primary transition-all relative group border border-foreground/5 shadow-sm ">
                            ...
                            {cartCount > 0 && (
                                <motion.span 
                                    initial={{ scale: 0 }}
                                    animate={{ scale: 1 }}
                                    className="absolute -top-2 -right-2 size-8 bg-primary text-white text-[12px] font-black rounded-full flex items-center justify-center border-4 border-[#050505] shadow-sm"
                                >
                                    {cartCount}
                                </motion.span>
                            )}
                                    ...
                                    {user ? (
                                        <div className="space-y-6">
                                            <Link to="/dashboard" onClick={() => setIsMenuOpen(false)} className="w-full">
                                                <button className="w-full h-28 rounded-3xl bg-primary text-white font-black text-2xl tracking-tighter uppercase shadow-sm  border-none flex items-center justify-center gap-8">
                                        ...
                                        <div className="flex flex-col gap-8">
                                            ...
                                            <Link to="/register" onClick={() => setIsMenuOpen(false)}>
                                                <button className="w-full h-28 rounded-3xl bg-primary text-white font-black text-2xl tracking-widest uppercase shadow-sm  border-none">
