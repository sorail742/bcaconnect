    ...
    return (
        ...
        >
            ...
            <div className="p-2.5 sm:p-3">
                <h3 className="text-[13px] text-[#333] leading-snug line-clamp-2 min-h-[2.5rem] group-hover:text-[#1CA0DB] transition-colors">
                    {product.nom_produit}
                </h3>
                ...
                <div className="flex items-center gap-2 mt-2 flex-wrap">
                    {verified && (
                        <span className="inline-flex items-center gap-0.5 text-[10px] font-semibold text-[#1CA0DB] bg-[#E6F7FD] px-1.5 py-0.5 rounded-sm">
