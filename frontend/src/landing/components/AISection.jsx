                ...
                <div className="grid lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#1CA0DB]/10 border border-[#1CA0DB]/20 rounded-full text-[#1CA0DB] text-[10px] font-black uppercase tracking-widest">
                        ...
                        <div className="grid gap-4">
                            {features.map((f, i) => (
                                <motion.div key={i} whileHover={{ x: 5 }} className="flex gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-[#1CA0DB]/30 transition-all">
                                    <div className="size-10 rounded-xl bg-[#1CA0DB]/20 flex items-center justify-center shrink-0">
                                        <f.icon className="size-5 text-[#1CA0DB]" />
                                    </div>
                                    <div>
                        ...
                        <button
                            ...
                            className="flex items-center gap-3 h-12 px-8 bg-[#1CA0DB] text-white font-black text-sm rounded-xl hover:shadow-blue-500/25 transition-all group"
                        >
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute -bottom-10 -left-10 size-40 bg-blue-500/10 blur-3xl pointer-events-none" />
                    </div>
                </div>
            </div>
        </section>
