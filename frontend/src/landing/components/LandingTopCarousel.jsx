...
const buildSlides = (t) => [
    {
        ...
        link: '/marketplace',
        accent: 'from-[#1CA0DB]/90 to-[#0e86b4]/80',
    },
    {
        src: img2,
        title: t('carouselTitle2') || 'Agriculture & logistique durable',
        subtitle: t('carouselSub2') || 'Des producteurs aux acheteurs B2B',
    ...
    },
    {
        ...
        subtitle: t('carouselSub3') || 'Crédit B2B · Escrow · Mobile Money',
    ...
    },
    {
        ...
        subtitle: t('carouselSub4') || 'Conakry & intérieur du pays',
        ...
        <section className="relative w-full h-[240px] sm:h-[300px] md:h-[360px] lg:h-[420px] overflow-hidden bg-[#1a1a1a]">
            ...
            <div className="relative z-10 h-full max-w-[1440px] mx-auto px-6 md:px-12 flex flex-col justify-center">
                ...
                >
                    ...
                    <Link
                        to={slide.link}
                        className="inline-flex mt-3 h-9 px-5 items-center bg-white text-[#1CA0DB] text-sm font-bold rounded-full hover:bg-[#eff6ff] transition-colors shadow-lg"
                    >
                        {slide.cta}
                    </Link>
                </motion.div>
