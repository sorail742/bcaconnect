            ...
            <div className="container px-3 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                    ...
                    <div className="flex-1 text-center lg:text-left space-y-6">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/10 text-[#1CA0DB] text-[11px] font-black uppercase tracking-widest">
                            <span className="size-2 rounded-full bg-[#1CA0DB] animate-pulse" />
                            {isAuthenticated
                        ...
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white leading-tight" style={{ fontFamily: "'Outfit', sans-serif" }}>
                            {isAuthenticated
                                ? <>{t('welcome') || "Bienvenue sur"} <span className="text-[#1CA0DB]">BCA Connect</span></>
                                : t('ctaMostAdvanced') || <>La plateforme de commerce <span className="text-[#1CA0DB]">la plus avancée</span> d'Afrique de l'Ouest</>
                            }
                        </h2>
                            ...
                            {isAuthenticated ? (
                                <>
                                    <button
                                        ...
                                        className="flex items-center gap-3 h-14 px-8 bg-[#1CA0DB] text-white font-black text-sm rounded-2xl shadow-lg hover:shadow-blue-500/25 hover:-translate-y-0.5 transition-all group"
                                    >
                    ...
                    <div className="grid grid-cols-2 gap-3 sm:gap-4 w-full max-w-sm lg:max-w-xs shrink-0">
                        {[
                            ...
                            <motion.button
                                ...
                                className="group text-left p-4 sm:p-5 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-[#1CA0DB]/30 transition-all"
                            >
                                <div className="size-10 rounded-xl bg-[#1CA0DB]/10 flex items-center justify-center mb-3 group-hover:bg-[#1CA0DB]/20 transition-colors">
                                    <item.icon className="size-5 text-[#1CA0DB]" />
                                </div>
