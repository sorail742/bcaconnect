...
import { formatNumber, formatDate } from '../../lib/i18nFormat';
import { DataStateWrapper } from '../../components/ui/DataStates';
import { useLanguage } from '../../context/useLanguage';
import { useMyCredits, usePayInstallment } from '../hooks/useCreditData';
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-widest">
                                                        Soumis le {formatDate(credit.created_at || credit.createdAt, lang)}
                                                        {credit.ia_score_solvabilite !== null && credit.ia_score_solvabilite !== undefined && ` • Score IA : ${parseFloat(credit.ia_score_solvabilite).toFixed(0)}%`}
                                                    </p>
                                                </div>
                                            </div>
                                            <div className="text-right">
                                                <p className="text-xl font-black text-primary tabular-nums">
                                                    {formatNumber(parseFloat(credit.montant_principal), lang)} <span className="text-xs">GNF</span>
                                                </p>
                                                ...
                                                {echeances.map((ech) => (
                                                    ...
                                                    >
                                                        ...
                                                        <p className="text-sm font-black text-foreground tabular-nums mb-2">
                                                            {formatNumber(parseFloat(ech.montant_du), lang)} GNF
                                                        </p>
                                                        {ech.statut !== 'paye' && (
                                                            <button
