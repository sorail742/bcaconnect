...
// Référence stable pour éviter qu'un `data || []` recrée un nouveau tableau à chaque
// rendu (casse les `useEffect` qui en dépendraient — voir useUserData.js pour le détail).
const EMPTY_ARRAY = [];
